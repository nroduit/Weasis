...
@XmlType(name = "rectangle", factoryMethod = "createDefaultInstance")
...
public class RectangleGraphic extends AbstractDragGraphicArea {
    ...
    public static RectangleGraphic createDefaultInstance() {
        return new RectangleGraphic(1.0f, Color.YELLOW, true);
    }

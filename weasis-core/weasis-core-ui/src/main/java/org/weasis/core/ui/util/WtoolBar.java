...
public class WtoolBar extends JPanel implements Toolbar {
   ...
   *
   * <p>Can be overridden to implement custom event handling.
   */
   ...
   *
   * <p>If true, when one of the toolbar buttons is rolled-over, its border will be shown.
   *
   * <p>DefaultValue is true
   */
   ...
   *
   * <p>If true, when one of the toolbar buttons is rolled-over, its content will be filled.
   *
   * <p>Default value is <b>false</b> to accommodate with VLButtonUI which paints itself the button
   * interiors.
   */
   ...
   *
   * <p>When set to true the installButtonUI() method will be called when a button is added to this
   * toolbar.
   */

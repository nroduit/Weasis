...
public class AdvancedShape implements Shape {
    ...
    public ScaleInvariantShape addScaleInvShape(Shape shape, Point2D anchorPoint, double scalingMin,
        boolean fixedLineWidth) {
        return addScaleInvShape(shape, anchorPoint, scalingMin, graphic.getStroke(graphic.getLineThickness()),
            fixedLineWidth);
    }

    public InvariantShape addAllInvShape(Shape shape, Point2D anchorPoint, Stroke stroke, boolean fixedLineWidth) {
        InvariantShape s = new InvariantShape(shape, stroke, anchorPoint, fixedLineWidth);
        shapeList.add(s);
        return s;
    }

    public LinkSegmentToInvariantShape addLinkSegmentToInvariantShape(Line2D line, Point2D anchorPoint, Shape invShape,
    ...
    public ScaleInvariantShape addScaleInvShape(Shape shape, Point2D anchorPoint, double scalingMin, Stroke stroke,
        boolean fixedLineWidth) {
    ...
    public ScaleInvariantShape addScaleInvShape(Shape shape, Point2D anchorPoint, Stroke stroke,
        boolean fixedLineWidth) {

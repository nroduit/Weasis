 ...
 */
@XmlType(name = "cobbAngle", factoryMethod = "createDefaultInstance")
...
public class CobbAngleToolGraphic extends OpenAngleToolGraphic {
    ...
    public static CobbAngleToolGraphic createDefaultInstance() {
        return new CobbAngleToolGraphic(1.0f, Color.YELLOW, true);
    }

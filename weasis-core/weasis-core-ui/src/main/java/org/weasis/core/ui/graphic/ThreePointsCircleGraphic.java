...
@XmlType(name = "threePointsCircle", factoryMethod = "createDefaultInstance")
...
public class ThreePointsCircleGraphic extends AbstractDragGraphicArea {
    ...
    public static ThreePointsCircleGraphic createDefaultInstance() {
        return new ThreePointsCircleGraphic(1.0f, Color.YELLOW, true);
    }

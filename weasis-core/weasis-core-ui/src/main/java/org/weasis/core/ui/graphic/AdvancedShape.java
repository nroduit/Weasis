...
public class AdvancedShape implements Shape {
    ...
    BasicShape addShape(Shape shape) {
        BasicShape s = new BasicShape(shape);
        shapeList.add(s);
        return s;
    }

    BasicShape addShape(Shape shape, Stroke stroke, boolean fixedLineWidth) {
    ...
    ScaleInvariantShape addScaleInvShape(Shape shape, Point2D anchorPoint) {
        return addScaleInvShape(shape, anchorPoint, graphic.getStroke(graphic.getLineThickness()), false);
    }

    ScaleInvariantShape addScaleInvShape(Shape shape, Point2D anchorPoint, double scalingMin, boolean fixedLineWidth) {
        return addScaleInvShape(shape, anchorPoint, scalingMin, graphic.getStroke(graphic.getLineThickness()),
            fixedLineWidth);
    }

    InvariantShape addAllInvShape(Shape shape, Point2D anchorPoint, Stroke stroke, boolean fixedLineWidth) {
        InvariantShape s = new InvariantShape(shape, stroke, anchorPoint, fixedLineWidth);
        shapeList.add(s);
        return s;
    }

    LinkSegmentToInvariantShape addLinkSegmentToInvariantShape(Line2D line, Point2D anchorPoint, Shape invShape,
        Stroke stroke, boolean fixedLineWidth) {
    ...
    ScaleInvariantShape addScaleInvShape(Shape shape, Point2D anchorPoint, double scalingMin, Stroke stroke,
        boolean fixedLineWidth) {
        ScaleInvariantShape s = new ScaleInvariantShape(shape, stroke, anchorPoint, scalingMin, fixedLineWidth);
        shapeList.add(s);
        return s;
    }

    ScaleInvariantShape addScaleInvShape(Shape shape, Point2D anchorPoint, Stroke stroke, boolean fixedLineWidth) {
    ...
    public class ScaleInvariantShape extends BasicShape {
        ...
        public ScaleInvariantShape(Shape shape, Stroke stroke, Point2D anchorPoint, boolean fixedLineWidth) {
            this(shape, stroke, anchorPoint, 0.0, fixedLineWidth);
        }

        public ScaleInvariantShape(Shape shape, Stroke stroke, Point2D anchorPoint, double scalingMin,
            boolean fixedLineWidth) {
    ...
    public class LinkSegmentToInvariantShape extends BasicShape {
        ...
        public LinkSegmentToInvariantShape(Line2D line, Stroke stroke, Point2D anchorPoint, Shape invShape,
            boolean fixedLineWidth) {

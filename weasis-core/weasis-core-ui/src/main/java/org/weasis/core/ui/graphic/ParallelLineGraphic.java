...
@XmlType(name = "ParallelLine", factoryMethod = "createDefaultInstance")
...
public class ParallelLineGraphic extends AbstractDragGraphic {
    ...
    public static ParallelLineGraphic createDefaultInstance() {
        return new ParallelLineGraphic(1.0f, Color.YELLOW, true);
    }

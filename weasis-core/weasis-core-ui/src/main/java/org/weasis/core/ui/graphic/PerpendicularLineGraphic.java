...
@XmlType(name = "perpendicularLine", factoryMethod = "createDefaultInstance")
...
public class PerpendicularLineGraphic extends AbstractDragGraphic {
    ...
    protected Point2D.Double ptA, ptB, ptC, ptD;
    ...
    public static PerpendicularLineGraphic createDefaultInstance() {
        return new PerpendicularLineGraphic(1.0f, Color.YELLOW, true);
    }

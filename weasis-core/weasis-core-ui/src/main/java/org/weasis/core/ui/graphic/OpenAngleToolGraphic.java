...
@XmlType(name = "openAngle", factoryMethod = "createDefaultInstance")
...
public class OpenAngleToolGraphic extends AbstractDragGraphic {
    ...
    public static OpenAngleToolGraphic createDefaultInstance() {
        return new OpenAngleToolGraphic(1.0f, Color.YELLOW, true);
    }

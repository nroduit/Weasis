...
public class FourPointsAngleToolGraphicTest extends GraphicTester<FourPointsAngleToolGraphic> {
    ...
    static {
        ...
        List<Point2D.Double> pts = Arrays.asList(new Point2D.Double(1294.5, 1528.0), new Point2D.Double(1456.5, 1498.0),
            new Point2D.Double(1181.5, 1553.0), new Point2D.Double(1430.5, 1638.0), new Point2D.Double(1438.5, 1525.0),
            new Point2D.Double(1367.5, 1717.0), new Point2D.Double(1498.5, 1556.0), new Point2D.Double(1540.5, 1643.0));

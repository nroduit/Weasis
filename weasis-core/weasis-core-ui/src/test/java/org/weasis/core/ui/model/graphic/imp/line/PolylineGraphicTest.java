...
public class PolylineGraphicTest extends GraphicTester<PolylineGraphic> {
    ...
    static final String BASIC_TPL = "<polyline fill=\"%s\" showLabel=\"%s\" thickness=\"%s\" uuid=\"%s\">" //$NON-NLS-1$
    ...
    static {
        ...
        List<Point2D.Double> pts = Arrays.asList(new Point2D.Double(935.5, 902.0), new Point2D.Double(1042.5, 863.0),
            new Point2D.Double(1188.5, 902.0), new Point2D.Double(1242.5, 997.0), new Point2D.Double(1409.5, 950.0),
            new Point2D.Double(1453.5, 1059.0), new Point2D.Double(1288.5, 1105.0), new Point2D.Double(1391.5, 1224.0),
            new Point2D.Double(1641.5, 1250.0), new Point2D.Double(1600.5, 1365.0), new Point2D.Double(1413.5, 1376.0),
            new Point2D.Double(1260.5, 1356.0), new Point2D.Double(1262.5, 1355.0));

...
public class RectangleGraphicTest extends GraphicTester<RectangleGraphic> {
    private static final String XML_0 = "/graphic/rectangle/rectangle.graphic.0.xml";
    private static final String XML_1 = "/graphic/rectangle/rectangle.graphic.1.xml";
    
    public static final String BASIC_TPL = 
            "<rectangle fill=\"%s\" showLabel=\"%s\" thickness=\"%s\" uuid=\"%s\">"
         +     "<paint rgb=\"%s\"/>"
         +     "<pts/>"
         + "</rectangle>";

...
public class PolygonGraphicTest extends GraphicTester<PolygonGraphic> {
    ...
    public static final String BASIC_TPL = "<polygon fill=\"%s\" showLabel=\"%s\" thickness=\"%s\" uuid=\"%s\">" //$NON-NLS-1$
    ...
    static {
        ...
        List<Point2D.Double> pts = Arrays.asList(new Point2D.Double(1132.5, 1100.0), new Point2D.Double(1300.5, 1033.0),
            new Point2D.Double(1345.5, 1089.0), new Point2D.Double(1329.5, 1296.0), new Point2D.Double(1034.5, 1292.0),

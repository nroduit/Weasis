...
public class Statistics {
  ...
  /**
   * This constructor creates a new <tt>Statistics</tt> object, and initializes the data array with
   * an array of Objects that must be convertable to numeric values.
   */
  ...
  /**
   * This method calculates the skewness of a data set. Skewness is the third central moment divided
  ...
  /**
   * This method calculates the kurtosis of a data set. Kurtosis is the fourth central moment
   * divided by the fourth power of the standard deviation.
   *
   * @param data The input data set
  ...
  public double orientationInRadian() {
    ...
    // This method computes the phase theta by computing an arc tangent of y/x in the range of -pi
    // to pi.

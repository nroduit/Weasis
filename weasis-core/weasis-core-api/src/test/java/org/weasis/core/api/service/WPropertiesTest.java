...
public class WPropertiesTest {
    ...
    public void testPutIntProperty() {
        ...
        Assert.assertEquals("different int", Integer.MIN_VALUE, prop.getIntProperty("int", 0), 0); // NON-NLS
        prop.putIntProperty("int", Integer.MAX_VALUE);
        Assert.assertEquals("different int", Integer.MAX_VALUE, prop.getIntProperty("int", 0), 0); // NON-NLS
    }
    ...
    public void testPutLongProperty() {
        ...
        Assert.assertEquals("different long", Long.MIN_VALUE, prop.getLongProperty("long", 0L), 0L); // NON-NLS
        prop.putLongProperty("long", Long.MAX_VALUE); //NON-NLS
        Assert.assertEquals("different long", Long.MAX_VALUE, prop.getLongProperty("long", 0L), 0L); // NON-NLS
    }
    ...
    public void testPutBooleanProperty() {
        ...
        Assert.assertEquals("different boolean", true, prop.getBooleanProperty("boolean", false)); // NON-NLS
        prop.putBooleanProperty("boolean", false); //NON-NLS
        Assert.assertEquals("different boolean", false, prop.getBooleanProperty("boolean", true)); // NON-NLS
    }
    ...
    public void testPutFloatProperty() {
        ...
        Assert.assertEquals("different float", Float.MAX_VALUE, prop.getFloatProperty("float", 0.0f), 0.0f); // NON-NLS
        prop.putFloatProperty("float", Float.NaN); //NON-NLS
        Assert.assertEquals("different float", Float.NaN, prop.getFloatProperty("float", 0.0f), 0.0f); // NON-NLS
    }
    ...
    public void testPutDoubleProperty() {
        ...
        Assert.assertEquals("different double", Math.PI, prop.getDoubleProperty("double", 0.0), 0.0); // NON-NLS
        prop.putDoubleProperty("double", Double.NEGATIVE_INFINITY); //NON-NLS
        Assert.assertEquals("different double", Double.NEGATIVE_INFINITY, prop.getDoubleProperty("double", 0.0), 0.0); // NON-NLS
        prop.putDoubleProperty("double", Double.NaN); //NON-NLS
        Assert.assertEquals("different double", Double.NaN, prop.getDoubleProperty("double", 0.0), 0.0); // NON-NLS
    }
    ...
    public void testPutByteArrayProperty() {
        ...
        Assert.assertArrayEquals("different byte data", data, prop.getByteArrayProperty("byte", null)); // NON-NLS
        prop.putByteArrayProperty("byte", null); //NON-NLS
        Assert.assertArrayEquals("different byte data", null, prop.getByteArrayProperty("byte", null)); // NON-NLS

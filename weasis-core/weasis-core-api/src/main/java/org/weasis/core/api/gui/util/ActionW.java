...
public class ActionW implements KeyActionValue {
    ...
    public static final ActionW SYNCH = new ActionW(Messages.getString("ActionW.synch"), "synch", 0, 0, null); // NON-NLS
    public static final ActionW VIEW_MODE =
        new ActionW(Messages.getString("ActionW.view_mode"), "viewMode", 0, 0, null);
    public static final ActionW ZOOM = new ActionW(Messages.getString("ActionW.zoom"), "zoom", KeyEvent.VK_Z, 0, // NON-NLS
        getCustomCursor("zoom.png", Messages.getString("ActionW.zoom"), 16, 16));
    public static final ActionW SCROLL_SERIES = new ActionW(Messages.getString("ActionW.scroll"), "sequence", // NON-NLS
        KeyEvent.VK_S, 0, getCustomCursor("sequence.png", Messages.getString("ActionW.scroll"), 16, 16));
    public static final ActionW ROTATION = new ActionW(Messages.getString("ActionW.rotate"), "rotation", KeyEvent.VK_R, // NON-NLS
        0, getCustomCursor("rotation.png", Messages.getString("ActionW.rotate"), 16, 16));

    public static final ActionW CINESPEED = new ActionW(Messages.getString("ActionW.speed"), "cinespeed", 0, 0, null); // NON-NLS
    public static final ActionW CINESTART =
        new ActionW(Messages.getString("ActionW.start"), "cinestart", KeyEvent.VK_C, 0, null); // NON-NLS
    public static final ActionW CINESTOP = new ActionW(Messages.getString("ActionW.stop"), "cinestop", 0, 0, null); // NON-NLS
    public static final ActionW WINDOW = new ActionW(Messages.getString("ActionW.win"), "window", 0, 0, null); // NON-NLS
    public static final ActionW LEVEL = new ActionW(Messages.getString("ActionW.level"), "level", 0, 0, null);
    public static final ActionW WINLEVEL = new ActionW(Messages.getString("ActionW.wl"), "winLevel", KeyEvent.VK_W, 0,
    ...
    public static final ActionW FLIP = new ActionW(Messages.getString("ActionW.flip"), "flip", 0, 0, null); // NON-NLS
    public static final ActionW PRESET = new ActionW(Messages.getString("ActionW.preset"), "preset", 0, 0, null); // NON-NLS
    public static final ActionW DEFAULT_PRESET = new ActionW("", "default_preset", 0, 0, null); // NON-NLS
    public static final ActionW LUT_SHAPE =
        new ActionW(Messages.getString("ActionW.lut_shape"), "lut_shape", 0, 0, null); // NON-NLS
    public static final ActionW LUT = new ActionW(Messages.getString("ActionW.lut"), "lut", 0, 0, null); // NON-NLS
    public static final ActionW INVERT_LUT =
        new ActionW(Messages.getString("ActionW.invert_lut"), "inverseLut", 0, 0, null);
    public static final ActionW RESET = new ActionW(Messages.getString("ActionW.Reset"), "reset", 0, 0, null); // NON-NLS
    public static final ActionW SHOW_HEADER =
        new ActionW(Messages.getString("ActionW.show_header"), "reset", 0, 0, null); // NON-NLS
    public static final ActionW PAN = new ActionW(Messages.getString("ActionW.pan"), "pan", KeyEvent.VK_T, 0, // NON-NLS
        getCustomCursor("pan.png", Messages.getString("ActionW.pan"), 16, 16));
    public static final ActionW DRAWINGS = new ActionW(Messages.getString("ActionW.draw"), "drawings", 0, 0, null); // NON-NLS
    public static final ActionW MEASURE =
        new ActionW(Messages.getString("ActionW.measure"), "measure", KeyEvent.VK_M, 0, null) { // NON-NLS
            @Override
    ...
    public static final ActionW DRAW_MEASURE =
        new ActionW(Messages.getString("ActionW.measurement"), DRAW_CMD_PREFIX + MEASURE.cmd(), 0, 0, null);
    ...
    public static final ActionW CONTEXTMENU =
        new ActionW(Messages.getString("ActionW.context_menu"), "contextMenu", KeyEvent.VK_Q, 0, null);
    public static final ActionW VIEWINGPROTOCOL = new ActionW("", "viewingProtocol", 0, 0, null); // NON-NLS
    public static final ActionW LAYOUT = new ActionW(Messages.getString("ActionW.layout"), "layout", 0, 0, null); // NON-NLS
    public static final ActionW MODE = new ActionW(Messages.getString("ActionW.switch_mode"), "mode", 0, 0, null); // NON-NLS
    public static final ActionW IMAGE_OVERLAY =
        new ActionW(Messages.getString("ActionW.overlay"), "overlay", 0, 0, null); // NON-NLS
    public static final ActionW PR_STATE = new ActionW(Messages.getString("ActionW.PR"), "pr_state", 0, 0, null); // NON-NLS
    public static final ActionW KO_TOOGLE_STATE =
        new ActionW(Messages.getString("ActionW.toggle_ko"), "ko_toogle_state", KeyEvent.VK_K, 0, // NON-NLS
            null);
    ...
    public static final ActionW SYNCH_CROSSLINE = new ActionW("", "synchCrossline", 0, 0, null); // NON-NLS
    ...
    public static final ActionW PREPROCESSING = new ActionW("", "preprocessing", 0, 0, null);// NON-NLS
    ...
    public static final ActionW FILTERED_SERIES = new ActionW("", "filter_series", 0, 0, null); // NON-NLS
    public static final ActionW CROSSHAIR = new ActionW(Messages.getString("ActionW.crosshair"), "crosshair", // NON-NLS

...
public abstract class DynamicMenu extends JMenu {
    ...
    public void addPopupMenuListener() {
        ...
        if (AppProperties.OPERATING_SYSTEM.startsWith("mac") && Boolean.TRUE.toString().equals(System.getProperty("apple.laf.useScreenMenuBar", Boolean.FALSE.toString()))) { // NON-NLS

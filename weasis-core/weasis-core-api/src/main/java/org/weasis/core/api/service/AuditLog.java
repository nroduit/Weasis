...
public class AuditLog {
  ...
  public static void createOrUpdateLogger(
  ...
  public static Configuration getLogConfiguration(
      ConfigurationAdmin confAdmin, String key, String val) throws IOException {
    Configuration logConfiguration = null;
    if (key != null && val != null) {
      try {
        Configuration[] configs =
            confAdmin.listConfigurations("(" + key + "=" + val + ")"); // NON-NLS

...
public class JIExplorerContext {
  ...
  public final synchronized void setSelectedDirNodes(
      final List<TreeNode> selectedDirNodes, final TreeNode lastSelectedDirNodes) {
    this.selectedDirNodes = selectedDirNodes;
    this.lastSelectedDirNodesIndex = this.selectedDirNodes.indexOf(lastSelectedDirNodes);
  }

  public final synchronized void setSelectedDirNodes(
      final List<TreeNode> selectedDirNodes, final int lastSelectedDirNodesIndex) {
    this.selectedDirNodes = selectedDirNodes;

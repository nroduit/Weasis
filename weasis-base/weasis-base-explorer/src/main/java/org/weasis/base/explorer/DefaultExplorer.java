  ...
  private void jTreeDiskValueChanged(final TreeSelectionEvent e) {
    ...
    if (selectedTreeNode != null) {
      ...
      final Path selectedDir =
          ((TreeNode) tree.getSelectionPath().getLastPathComponent()).getNodePath();
      if (selectedDir != null) {
  ...
  public JPopupMenu buildContextMenu(final MouseEvent e) {
    ...
    try {
          ...
          new JMenuItem(
              new DefaultAction(
                  tree.isExpanded(path)
                      ? Messages.getString("DefaultExplorer.collapse")
                      : Messages.getString("DefaultExplorer.expand"),
                  event -> {
      ...
      menuItem =
          new JMenuItem(
              new DefaultAction(
                  Messages.getString("DefaultExplorer.refresh"),
                  event -> {
                    repaint();
                    refresh();
                  }));
        ...
        for (final DataExplorerView dataExplorerView : UIManager.EXPLORER_PLUGINS) {
          if (dataExplorerView != DefaultExplorer.this) {
            ...
            JMenuItem item =
                new JMenuItem(
                    new DefaultAction(
                        dataExplorerView.getUIName(),
                        event -> {
                          final Path selectedDir =
                              ((TreeNode)
                                      DefaultExplorer.this
                                          .tree
                                          .getSelectionPath()

...
public class AcquireSerieMeta extends AcquireMetadataTableModel {
    ...
    private static final TagW[] TAGS_TO_DISPLAY = getTags("weasis.acquire.meta.series.display",
        "Modality,OperatorsName,ReferringPhysicianName,BodyPartExamined,SeriesDescription");
    private static final TagW[] TAGS_EDITABLE =
        getTags("weasis.acquire.meta.series.edit", "ReferringPhysicianName,BodyPartExamined,SeriesDescription");
    private static final TagW[] TAGS_TO_PUBLISH =
        getTags("weasis.acquire.meta.series.required", "Modality,SeriesDescription");

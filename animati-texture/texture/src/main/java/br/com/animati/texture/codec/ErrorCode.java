...
public enum ErrorCode {
    ...
    err500("500",
            "This series has variable RescaleIntercept and/or RescaleSlope. Can't be rendered on H.A.",
            Messages.getString("err500")),
    err501("501",
            "Can't send frame to texture: diferent frame sizes or inconsistent size information.",

...
public class MenuAccordion extends JPanel implements ActionListener {
     ...
     * ChangeEvents are fired when any item's state (open/close) changes.
    ...
    public class AccordionItem extends JButton {
        ...
        public void setButtonIcon(ImageIcon icon) {
            this.icon = icon;               
            removeAll();
            JLabel titleLabel= new JLabel(titleButton, JLabel.LEFT);            
            add(titleLabel, BorderLayout.WEST);                        
            JLabel iconLabel = new JLabel(this.icon, JLabel.RIGHT);         
            add(iconLabel, BorderLayout.EAST);
        }

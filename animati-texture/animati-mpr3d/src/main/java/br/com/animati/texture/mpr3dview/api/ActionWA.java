...
public class ActionWA {
    ...
    public static final ActionW VOLUM_RENDERING = new ActionW(
            "Volumetric Rendering", "volumetricRendering", 0, 0, null);
    
    /** volumetricQuality: int. */
    public static final ActionW VOLUM_QUALITY = new ActionW(
            "Volumetric Quality", "volumetricQuality", 0, 0, null);
    
    /** volumetricCenterSlicing: boolean. */
    public static final ActionW VOLUM_CENTER_SLICING = new ActionW(
            "Volumetric Center Slicing", "volumetricCenterSlicing", 0, 0, null);
    
    /** volumetricDithering: boolean. */
    public static final ActionW VOLUM_DITHERING = new ActionW(
            "Volumetric Dithering", "volumetricDithering", 0, 0, null);
    
    /** volumetricLighting: boolean. */
    public static final ActionW VOLUM_LIGHT = new ActionW(

...
public class DicomPrintOptionPane extends JPanel {
  ...
  private void initComponents() {
    ...
    mediumTypeLabel.setText(Messages.getString("DicomPrintDialog.med_type") + StringUtil.COLON);
    ...
    priorityLabel.setText(Messages.getString("DicomPrintDialog.priority") + StringUtil.COLON);
    ...
    filmDestinationLabel.setText(
        Messages.getString("DicomPrintDialog.film_dest") + StringUtil.COLON);
    ...
    filmDestinationComboBox.setModel(
        new DefaultComboBoxModel<>(new String[] {DicomPrintOptions.DEF_FILM_DEST, "PROCESSOR"}));
    ...
    numOfCopiesLabel.setText(Messages.getString("DicomPrintDialog.copies") + StringUtil.COLON);
    ...
    colorPrintCheckBox.setText(Messages.getString("DicomPrintDialog.print_color"));
    ...
    filmOrientationLabel.setText(
        Messages.getString("DicomPrintDialog.film_orientation") + StringUtil.COLON);
    ...
    filmOrientationComboBox.setModel(
        new DefaultComboBoxModel<>(
    ...
    filmSizeIdLabel.setText(Messages.getString("DicomPrintDialog.size_id") + StringUtil.COLON);
    ...
    imageDisplayLabel.setText(
        Messages.getString("DicomPrintDialog.disp_format") + StringUtil.COLON);
    ...
    magnificationTypeLabel.setText(
        Messages.getString("DicomPrintDialog.magn_type") + StringUtil.COLON);
    ...
    magnificationTypeComboBox.setModel(
        new DefaultComboBoxModel<>(
            new String[] {
    ...
    smoothingTypeLabel.setText(Messages.getString("DicomPrintDialog.smooth") + StringUtil.COLON);
    ...
    borderDensityLabel.setText(Messages.getString("DicomPrintDialog.border") + StringUtil.COLON);
    ...
    borderDensityComboBox.setModel(
        new DefaultComboBoxModel<>(new String[] {"BLACK", DicomPrintOptions.DEF_BORDER_DENSITY}));
    ...
    // minDensityLabel.setText(Messages.getString("DicomPrintDialog.min_density") +
    // StringUtil.COLON);
    ...
    // maxDensityLabel.setText(Messages.getString("DicomPrintDialog.max_density") +
    // StringUtil.COLON);
    ...
    trimLabel.setText(Messages.getString("DicomPrintDialog.trim") + StringUtil.COLON);
    ...
    labelEmpty.setText(Messages.getString("DicomPrintDialog.empty_density") + StringUtil.COLON);
    ...
    comboBoxEmpty.setModel(
        new DefaultComboBoxModel<>(new String[] {DicomPrintOptions.DEF_EMPTY_DENSITY, "WHITE"}));
    ...
    printAnnotationsCheckBox.setText(Messages.getString("PrintDialog.annotate"));
    ...
    label = new JLabel();
    label.setText(Messages.getString("DicomPrintDialog.dpi") + StringUtil.COLON);

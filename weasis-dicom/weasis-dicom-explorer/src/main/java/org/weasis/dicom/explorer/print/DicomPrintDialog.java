...
public class DicomPrintDialog extends JDialog {
    ...
    public DicomPrintDialog(Window parent, String title, ImageViewerEventManager eventManager) {
        ...
        portraitDisplayFormatsModel =
            new DefaultComboBoxModel(new String[] { "STANDARD\\1,1", "STANDARD\\1,2", "STANDARD\\2,2", "STANDARD\\2,3",
                "STANDARD\\3,3", "STANDARD\\3,4", "STANDARD\\3,5", "STANDARD\\4,4", "STANDARD\\4,5", "STANDARD\\4,6" });

        landscapeDisplayFormatsModel =
            new DefaultComboBoxModel(new String[] { "STANDARD\\1,1", "STANDARD\\2,1", "STANDARD\\2,2", "STANDARD\\3,2",
                "STANDARD\\3,3", "STANDARD\\4,3", "STANDARD\\5,3", "STANDARD\\4,4", "STANDARD\\5,4" });
    ...
    private void initComponents() {
        ...
        printersCfg.setBorder(new TitledBorder(null, "DICOM Printer", TitledBorder.LEADING, TitledBorder.TOP, null,
            null));
        ...
        content.setBorder(new TitledBorder(null, "Print Options", TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        mediumTypeComboBox.setModel(new DefaultComboBoxModel(new String[] { "BLUE FILM", "CLEAR FILM" }));
        ...
        priorityComboBox.setModel(new DefaultComboBoxModel(new String[] { "LOW", "MED", "HIGH" }));
        ...
        filmDestinationComboBox.setModel(new DefaultComboBoxModel(new String[] { "MAGAZINE", "PROCESSOR" }));
        ...
        numOfCopiesLabel.setText("Copies:");
        ...
        filmOrientationComboBox.setModel(new DefaultComboBoxModel(new String[] { "PORTRAIT", "LANDSCAPE" }));
        ...
        imageDisplayLabel.setText("Display Format:");
        ...
        filmSizeIdComboBox.setModel(new DefaultComboBoxModel(new String[] { "8INX10IN", "11INX14IN", "14INX14IN",
            "14INX17IN" }));
        ...
        magnificationTypeLabel.setText("Magnification Type:");
        ...
        magnificationTypeComboBox.setModel(new DefaultComboBoxModel(new String[] { "BILINEAR", "CUBIC", "NONE" }));
        ...
        smoothingTypeComboBox.setModel(new DefaultComboBoxModel(new String[] { "MEDIUM", "SHARP", "SMOOTH" }));
        ...
        borderDensityComboBox.setModel(new DefaultComboBoxModel(new String[] { "BLACK", "WHITE" }));
        ...
        minDensitySpinner = new JSpinner(new SpinnerNumberModel(0, 0, 300, 1));
        ...
        maxDensitySpinner = new JSpinner(new SpinnerNumberModel(0, 0, 300, 1));
        ...
        trimComboBox.setModel(new DefaultComboBoxModel(new String[] { "NO", "YES" }));
        ...
        addPrinterButton = new JButton("Add new");

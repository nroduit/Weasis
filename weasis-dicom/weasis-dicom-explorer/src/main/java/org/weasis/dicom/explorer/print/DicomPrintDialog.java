...
public class DicomPrintDialog extends JDialog {
    ...
    enum FilmSize {
                   IN8X10("8INX10IN", 8, 10), IN8_5X11("8_5INX11IN", 8.5, 11), IN10X12("10INX12IN", 10, 12),
                   IN10X14("10INX14IN", 10, 14), IN11X14("11INX14IN", 11, 14), IN11X17("11INX17IN", 11, 17),
                   IN14X14("14INX14IN", 14, 14), IN14X17("14INX17IN", 14, 17),
                   CM24X24("24CMX24CM", convertMM2Inch(240), convertMM2Inch(240)),
                   CM24X30("24CMX30CM", convertMM2Inch(240), convertMM2Inch(300)),
                   A4("A4", convertMM2Inch(210), convertMM2Inch(297)),
                   A3("A3", convertMM2Inch(297), convertMM2Inch(420));
    ...
    private void initComponents() {
        ...
        mediumTypeComboBox.setModel(new DefaultComboBoxModel(
            new String[] { "BLUE FILM", "CLEAR FILM", "MAMMO CLEAR FILM", "MAMMO BLUE FILM", "PAPER" })); //$NON-NLS-1$ //$NON-NLS-2$

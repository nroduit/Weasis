    ...
    public CineToolBar(int index) {
        ...
        if (sequence instanceof SliderCineListener) {
            ...
            if (p.getBooleanProperty("weasis.cinetoolbar.gotostart", true)) {
                ...
                rwdButton.setIcon(new ImageIcon(CineToolBar.class.getResource("/icon/24x24/player-rwd.png")));
            ...
            if (p.getBooleanProperty("weasis.cinetoolbar.prev", true)) {
                ...
                prevButton.setIcon(new ImageIcon(CineToolBar.class.getResource("/icon/24x24/player-prev.png")));
            ...
            if (p.getBooleanProperty("weasis.cinetoolbar.pause", true)) {
                ...
                pauseButton.setIcon(new ImageIcon(CineToolBar.class.getResource("/icon/24x24/player-pause.png")));
            ...
            if (p.getBooleanProperty("weasis.cinetoolbar.start", true)) {
                ...
                startButton.setIcon(new ImageIcon(CineToolBar.class.getResource("/icon/24x24/player-play.png")));
            ...
            if (p.getBooleanProperty("weasis.cinetoolbar.stop", true)) {
                ...
                stopButton.setIcon(new ImageIcon(CineToolBar.class.getResource("/icon/24x24/player-stop.png")));
            ...
            if (p.getBooleanProperty("weasis.cinetoolbar.next", true)) {
                ...
                nextButton.setIcon(new ImageIcon(CineToolBar.class.getResource("/icon/24x24/player-next.png")));
            ...
            if (p.getBooleanProperty("weasis.cinetoolbar.gotoend", true)) {
                ...
                fwdButton.setIcon(new ImageIcon(CineToolBar.class.getResource("/icon/24x24/player-fwd.png")));

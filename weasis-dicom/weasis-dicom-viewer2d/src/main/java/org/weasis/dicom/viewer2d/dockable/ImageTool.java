...
public class ImageTool extends PluginTool {
    ...
    public JPanel getResetPanel() {
        ...
        panel2.setBorder(
            BorderFactory.createCompoundBorder(spaceY, new TitledBorder(null, Messages.getString("ResetTools.reset"),
    ...
    public JPanel getTransformPanel() {
        ...
        if (flipAction instanceof ToggleButtonListener) {
            ...
            pane.add(((ToggleButtonListener) flipAction).createCheckBox(Messages.getString("View2dContainer.flip_h")));
            transform.add(pane);
        }
        return transform;
    }

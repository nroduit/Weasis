...
public class PresetWindowLevel {
    ...
    public final static PresetWindowLevel CUSTOM = new PresetWindowLevel(Messages.getString("PresetWindowLevel.custom"), Messages.getString("PresetWindowLevel.all"), 0f, 0f); //$NON-NLS-1$ //$NON-NLS-2$
    public final static PresetWindowLevel DEFAULT = new PresetWindowLevel(Messages.getString("PresetWindowLevel.default"), Messages.getString("PresetWindowLevel.all"), 0f, 0f); //$NON-NLS-1$ //$NON-NLS-2$
    public final static PresetWindowLevel AUTO = new PresetWindowLevel(Messages.getString("PresetWindowLevel.full"), Messages.getString("PresetWindowLevel.all"), 0f, 0f); //$NON-NLS-1$ //$NON-NLS-2$

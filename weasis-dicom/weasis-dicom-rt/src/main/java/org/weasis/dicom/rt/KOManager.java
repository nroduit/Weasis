...
import org.weasis.dicom.viewer2d.*;
...
public final class KOManager {
    ...
    public static KOSpecialElement getValidKOSelection(final DefaultView2d<DicomImageElement> view2d) {
        ...
        if (currentSelectedKO == null) {
            ...
            if (validKOSelection != null) {
                ...
                String message = org.weasis.dicom.viewer2d.Messages.getString("KOManager.select_KO_msg"); //$NON-NLS-1$
                Object[] options =
                    { org.weasis.dicom.viewer2d.Messages.getString("KOManager.select_last_ko"), org.weasis.dicom.viewer2d.Messages.getString("KOManager.new_ko") }; //$NON-NLS-1$ //$NON-NLS-2$

                int response = JOptionPane.showOptionDialog(view2d, message, org.weasis.dicom.viewer2d.Messages.getString("KOManager.ko_title"), //$NON-NLS-1$
            ...
            if (currentSelectedKO.getMediaReader().isEditableDicom()) {
                ...
                if (currentSelectedKO.isEmpty()
                    ...
                    String message = org.weasis.dicom.viewer2d.Messages.getString("KOManager.no_ko_msg"); //$NON-NLS-1$
                    Object[] options =
                        { org.weasis.dicom.viewer2d.Messages.getString("KOManager.use_ko"), org.weasis.dicom.viewer2d.Messages.getString("KOManager.new_ko") }; //$NON-NLS-1$ //$NON-NLS-2$

                    int response =
                        JOptionPane.showOptionDialog(view2d, message, org.weasis.dicom.viewer2d.Messages.getString("KOManager.ko_title"), //$NON-NLS-1$
                            JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE, null, options, options[0]);
                ...
                String message = org.weasis.dicom.viewer2d.Messages.getString("KOManager.ko_readonly"); //$NON-NLS-1$
                Object[] options =
                    { org.weasis.dicom.viewer2d.Messages.getString("KOManager.new_ko"), org.weasis.dicom.viewer2d.Messages.getString("KOManager.new_ko_from") }; //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public static Attributes createNewDicomKeyObject(MediaElement<?> dicomMediaElement, Component parentComponent) {
        ...
        if (dicomMediaElement != null && dicomMediaElement.getMediaReader() instanceof DcmMediaReader) {
            ...
            String message = org.weasis.dicom.viewer2d.Messages.getString("KOManager.ko_desc"); //$NON-NLS-1$
            String defautDescription = org.weasis.dicom.viewer2d.Messages.getString("KOManager.ko_name"); //$NON-NLS-1$
    ...
    public static boolean setKeyObjectReferenceAllSeries(boolean selectedState,
        ...
        KOSpecialElement currentSelectedKO = org.weasis.dicom.viewer2d.KOManager.getCurrentKOSelection(view2d);

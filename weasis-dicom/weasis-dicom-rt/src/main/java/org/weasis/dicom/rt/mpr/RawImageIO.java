...
import org.weasis.dicom.viewer2d.mpr.ImageParameters;

public class RawImageIO implements DcmMediaReader<PlanarImage> {
    private static final Logger LOGGER = LoggerFactory.getLogger(org.weasis.dicom.viewer2d.mpr.RawImageIO.class);
